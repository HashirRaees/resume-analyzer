      ...
      <div className="min-h-screen bg-gray-50/50 pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 gap-4">
            <div>
              <h1 className="text-4xl font-bold text-gray-900 tracking-tight">Job Tracker</h1>
              <p className="text-gray-500 mt-2 text-lg">Track your job applications and interviews</p>
            </div>
            <Button
          ...
          <Card className="overflow-hidden border-0 shadow-xl shadow-gray-200/40">
            {loadingJobs ? (
              ...
              <div className="p-16 text-center">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">No jobs tracked yet</h3>
                <p className="text-gray-500 mb-8">Start tracking your applications today!</p>
          ...
          {jobs.length > 0 && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
              ...
              <Card className="p-6 text-center border-0 bg-blue-50">
                <p className="text-blue-600 text-sm font-medium uppercase tracking-wide">Applied</p>
                <p className="text-3xl font-bold text-blue-700 mt-2">
                  {jobs.filter((j) => j.status === 'Applied').length}
                </p>
              </Card>
              <Card className="p-6 text-center border-0 bg-purple-50">
                <p className="text-purple-600 text-sm font-medium uppercase tracking-wide">Interviewing</p>
                <p className="text-3xl font-bold text-purple-700 mt-2">
                  {jobs.filter((j) => j.status === 'Interviewing').length}
                </p>
              </Card>
              <Card className="p-6 text-center border-0 bg-green-50">
                <p className="text-green-600 text-sm font-medium uppercase tracking-wide">Offered</p>
